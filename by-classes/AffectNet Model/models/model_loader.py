...
from emotion.emotion_predictor import AffectNetEmotionRecognition
...
@st.cache_resource
def load_affectnet_emotion_recognition():
    emotion_model, va_model = load_models()
    return AffectNetEmotionRecognition(emotion_model, va_model)
