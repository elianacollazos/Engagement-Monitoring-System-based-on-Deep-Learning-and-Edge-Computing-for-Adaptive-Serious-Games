...
MODEL_TYPE = os.getenv('MODEL_TYPE', 'regularized')  # Options: modern, regularized, original, transfer
MODEL_TYPE_PROD = os.getenv('MODEL_TYPE_PROD', 'regularized')  # Model type for production/inference
MODEL_PATH = os.getenv('MODEL_PATH', os.path.join(SAVED_MODELS_DIR, 'regularized_best_model_20260412_224038.pth'))
